...
var addToCart = document.querySelectorAll('.add-to-cart'); //  this query selector all will give the array all results
...
function updateCart(items) {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default().post('/update-cart', items).then(function (res) {
    // (res =>{}) same thing  
...
addToCart.forEach(function (btn) {
  // we gave the name btn to the element of the array
  btn.addEventListener('click', function (e) {
    // this is getting from home.ejs data-(ourname) ie. data-items 
    var items = JSON.parse(btn.dataset.items); // It will convert the json string format to object  
